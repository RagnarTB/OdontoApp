 ...
 * Maneja la disponibilidad, agendamiento, reprogramación, cancelación y
...
public interface CitaService {
     ...
     * @return Mapa con los horarios disponibles y ocupados
     */
    Map<String, Object> buscarDisponibilidad(Long odontologoId, LocalDate fecha, Integer duracionMinutos,
            Long citaIdExcluir);

    /**
     * Agenda una nueva cita para un paciente (desde admin panel).
     * Valida la disponibilidad del odontólogo y detecta conflictos de horario.
     * La cita se crea con estado CONFIRMADA.
     *
    ...
    /**
     * Agenda una nueva cita desde el portal del paciente.
     * Valida la disponibilidad del odontólogo y detecta conflictos de horario.
     * La cita se crea con estado PENDIENTE (requiere confirmación del personal).
     *
     * @param pacienteId      ID del paciente
     * @param odontologoId    ID del odontólogo
     * @param procedimientoId ID del procedimiento a realizar
     ...
     * @throws IllegalArgumentException si los parámetros no son válidos
     */
    Cita agendarCitaPaciente(Long pacienteId, Long odontologoId, Long procedimientoId,
            LocalDateTime fechaHoraInicio, String motivoConsulta, String notas);
     ...
     * @param nuevoOdontologoId    ID del nuevo odontólogo (null para mantener el
     *                             mismo)
     ...
     * @param esPaciente true si la cancelación es por el paciente, false si es por
     *                   la clínica
     ...
     * @throws IllegalStateException si la cita no está confirmada o si ya se marcó
     *                               asistencia
     */
     ...
     * @throws jakarta.persistence.EntityNotFoundException si no se encuentra la
     *                                                     cita
     */
     ...
     *
     * @param odontologoId ID del odontólogo
     * @param fecha        Fecha para buscar citas (opcional, si es null busca
     *                     todas)
     * @param pageable     Configuración de paginación
